-- Elixhauser comorbidity flags and van Walraven score for all HNC universe patients
...
DROP TABLE IF EXISTS hnc_comorbidity;

CREATE TABLE hnc_comorbidity AS
...
WITH dx_raw AS (
    ...
    JOIN hnc_universe h ON i.DSYSRTKY = h.DSYSRTKY,
    UNNEST([
    ...
    JOIN hnc_universe h ON c.DSYSRTKY = h.DSYSRTKY
    ...
    JOIN hnc_universe h ON oc.DSYSRTKY = h.DSYSRTKY,
    UNNEST([
        oc.PRNCPAL_DGNS_CD,
